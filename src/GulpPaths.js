 ...
 * @return {GulpPaths}
 */
GulpPaths.prototype.src = (src, prefix) => {
 ...
 * @return {GulpPaths}
 */
GulpPaths.prototype.output = (output, defaultName) => {
 ...
 * @return {string}
 */
GulpPaths.prototype.changeExtension = (path, newExtension) => {
 ...
 * @return {string|Array}
 */
GulpPaths.prototype.prefix = (path, prefix) => {
 ...
 * @return {object}
 */
GulpPaths.prototype.parse = (path) => {
